...
// components
import ImportChild from "@/components2/Model/ImportChild";
import BoxNew from "../BoxComponent/BoxNew";
// import CSVReader from "@/components/ReadCSV/CSVReader2";
import DetailImport from "@/components2/Model/detail_model";
...
export default function ImportBox({}: Props) {
  ...
  const childToParent = (childdata: any, id: number) => {
    ...
    setFormData((prevData) => ({ ...prevData, [id]: `${childdata.elements.code1}
                                                      ...
                                                      \n${childdata.elements.code16}
                                                      \n${childdata.elements.code17}
                                                      \n${childdata.elements.code18}
                                                      \n${childdata.elements.code19}
                                                      \n${childdata.elements.code20}
                                                      \n${childdata.elements.code21}
                                                      \n${childdata.elements.code22}
                                                      \n${childdata.elements.code23}
                                                      \n${childdata.elements.code24}
                                                      \n${childdata.elements.code25}`}));
};
